...
ActiveRecord::Schema.define(version: 20171005194519) do
  ...
  add_index "coments", ["commentable_type", "commentable_id"], name: "index_coments_on_commentable_type_and_commentable_id"
